# Generated by Powerlevel10k configuration wizard on 2019-08-20 at 13:27 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 19806.
# Wizard options: nerdfont-complete + powerline, large icons, classic, lightest,
...
() {
  ...
  vcs+=':-%250F@%76F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%250F:%76F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%250F#%76F${VCS_STATUS_TAG//\%/%%}}'
